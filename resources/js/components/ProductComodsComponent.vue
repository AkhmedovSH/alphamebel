        ...
        <div class="single-goods container">
            <form class="filter col-xl-3 col-lg-3">
                ...
                <div id="filterContent" class="content">
                    ...
                    <div class="colors">
                        <h4 class="filteropentitle colors-title-closed">Цвет</h4>
                        <ul class="list colors-list">
                            <li>
                                <input class="filter-items" id="light" type="checkbox" />
                                <label for="light">Светлый</label>
                            </li>
                            <li>
                                <input class="filter-items" id="dark" type="checkbox" />
                                <label for="dark">Темный</label>
                            </li>
                        </ul>
                    </div>
                    <div class="doors">
                        <h4 class="filteropentitle doors-title-closed">Количество дверей</h4>
                        <ul class="list doors-list">
                            <li>
                                <input class="filter-items" id="one" type="checkbox" />
                                <label for="one">1</label>
                            </li>
                            <li>
                                <input class="filter-items" id="two" type="checkbox" />
                                <label for="two">2</label>
                            </li>
                            <li>
                                <input class="filter-items" id="three" type="checkbox" />
                                <label for="three">3</label>
                            </li>
                        </ul>
                    </div>
                    <div class="boxes">
                        <h4 class="filteropentitle boxes-title-closed">Количество ящиков</h4>
                        <ul class="list boxes-list">
                            <li>
                                <input class="filter-items" id="oneboxes" type="checkbox" />
                                <label for="oneboxes">1</label>
                            </li>
                            <li>
                                <input class="filter-items" id="twoboxes" type="checkbox" />
                                <label for="twoboxes">2</label>
                            </li>
                            <li>
                                <input class="filter-items" id="threeboxes" type="checkbox" />
                                <label for="threeboxes">3</label>
                            </li>
                            <li>
                                <input class="filter-items" id="fourboxes" type="checkbox" />
                                <label for="fourboxes">4</label>
                            </li>
                            <li>
                                <input class="filter-items" id="fiveboxes" type="checkbox" />
                                <label for="fiveboxes">5</label>
                            </li>
                            <li>
                                <input class="filter-items" id="sixboxes" type="checkbox" />
                                <label for="sixboxes">6</label>
                            </li>
                        </ul>
                    </div>
                    <div class="direction">
                        ...
                        <ul class="list direction-list">
                            <li>
                                <input class="filter-items" id="bedroom" type="checkbox" />
                                <label for="bedroom">Спальни</label>
                            </li>
                            <li>
                                <input class="filter-items" id="livingroom" type="checkbox" />
                                <label for="livingroom">Гостиные</label>
                            </li>
                            <li>
                                <input class="filter-items" id="nursery" type="checkbox" />
                                <label for="nursery">Молодежные</label>
                            </li>
                            <li>
                                <input class="filter-items" id="interior" type="checkbox" />
                                <label for="interior">Предметы интерьера</label>
                            </li>
                            <li>
                                <input class="filter-items" id="otherproduct" type="checkbox" />
                                <label for="otherproduct">Сторонняя продукция</label>
                            </li>
                        </ul>
                    </div>
                    <div class="directors">
                        <h4 class="filteropentitle directors-title-closed">Направляющие</h4>
                        <ul class="list directors-list">
                            <li>
                                <input class="filter-items" id="without" type="checkbox" />
                                <label for="without">Без доводчика</label>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="goodscard content">
                            <div class="img">
                                <a href="../beds/bed1.html" class="goodsimg-main card_main">
                                    <img src="/assets/img/goods/comods/comods.jpg" alt="" class="main_img">
                                </a>
                                <div class="img_markers">
                                    <img src="/assets/img/goods/comods/comods.jpg" alt="" class="img_item1">
