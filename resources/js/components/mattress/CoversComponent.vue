        ...
        <div id="filterContent" class="content">
            <div class="collection">
                ...
                <ul class="list collection-list">
                    <li>
                        <input class="filter-items" id="coverdefend" type="checkbox" />
                        <label for="coverdefend">Защитные чехлы</label>
                    </li>
                </ul>
            </div>
            <div class="waterproof">
                <h4 class="filteropentitle waterproof-title-closed">Влагостойкость чехла</h4>
                <ul class="list waterproof-list">
                    <li>
                        <input class="filter-items" id="coverwateryes" type="checkbox" />
                        <label for="coverwateryes">Да</label>
                    </li>
                    <li>
                        <input class="filter-items" id="coverwaterno" type="checkbox" />
                        <label for="coverwaterno">Нет</label>
                    </li>
                </ul>
            </div>
                ...
                <div class="goodscard content">
                    <div class="img">
                        <a href="mattrass1.html" class="goodsimg-main card_main">
                            <img src="/assets/img/goods/mattrasses/cover.jpg" alt=""
                                class="main_img">
                        </a>
