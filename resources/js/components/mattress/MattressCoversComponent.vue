    ...
    <form class="filter marginhas col-xl-3 col-lg-3">
        ...
        <div id="filterContent" class="content">
            <div class="collection">
                <h4 class="filteropentitle collection-title-closed">Коллекция</h4>
                <ul class="list collection-list">
                    <li>
                        <input class="filter-items" id="onmattress" type="checkbox" />
                        <label for="onmattress">Наматрасники</label>
                    </li>
                </ul>
            </div>
            <div class="hardness">
                <h4 class="filteropentitle hardness-title-closed">Жесткость наматрасника</h4>
                <ul class="list hardness-list">
                    <li>
                        <input class="filter-items" id="onmattress-hard" type="checkbox" />
                        <label for="onmattress-hard">Жесткий</label>
                    </li>
                    <li>
                        <input class="filter-items" id="onmattress-hard-middle" type="checkbox" />
                        <label for="onmattress-hard-middle">Жесткий / Средн.жесткий</label>
                    </li>
                    <li>
                        <input class="filter-items" id="onmattress-soft" type="checkbox" />
                        <label for="onmattress-soft">Мягкий</label>
                    </li>
                    <li>
                        <input class="filter-items" id="onmattress-soft-middle" type="checkbox" />
                        <label for="onmattress-soft-middle">Мягкий / Срежн.жесткий</label>
                    </li>
                </ul>
            </div>
            <div class="btns">
        ...
        <div class="cards contents">
            <div class="blogBox moreBox sub-content col-xl-4 col-lg-6 col-md-6 col-sm-12">
                <div class="goodscard content">
                    <div class="img">
                        <a href="mattrass1.html" class="goodsimg-main card_main">
                            <img src="/assets/img/goods/mattrasses/onmattress.jpg" alt=""
                                class="main_img">
                        </a>
